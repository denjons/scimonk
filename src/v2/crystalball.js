...
export function lineNormal(u,v){
  ...
  setLight(tringle, colour) { 
    ...
    this._normal[0] = origin[0] - tringle.points[0][0];
    this._normal[1] = origin[1] - tringle.points[0][1];
    this._normal[2] = origin[2] - tringle.points[0][2];
    ...
    const b = Math.sqrt(this._n[0]*this._n[0] + this._n[1]*this._n[1] + this._n[2]*this._n[2]);
    this._normal[0] /= b;
    this._normal[1] /= b;
    this._normal[2] /= b;
    ...
    */
    ...
    return [
      Math.max(colour[0] - colour[0] * cosA, 1),
      Math.max(colour[1] - colour[1] * cosA, 1),
      Math.max(colour[2] - colour[2] * cosA, 1),
      200 + 55 * cosA
    ];
  }
